...
export default function About(props) {
  ...
  return (
    <div className='container my-4 mb-5' style={{color : props.mode === 'dark'? 'white':'black'}}>
      <h3>About Us</h3>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum voluptates laudantium dolore nisi magnam debitis veniam quos nihil exercitationem veritatis iure consequuntur harum dolor cupiditate, placeat quod itaque excepturi accusamus?</p>
